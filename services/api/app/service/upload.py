...
# Source media this archive accepts. Audio + video formats WhisperX / ffmpeg
# can decode. Kept deliberately tight — everything here lands under the
# media/ prefix and becomes a candidate for transcription.
ALLOWED_TYPES = {
    "audio/mpeg",
    "audio/wav",
    "audio/x-wav",
...
def process_upload(
    ...
    #
    # Source media lands under the configured media/ prefix; the Library and
    # batch transcribe iterate exactly this prefix, and every transcript /
    # segment / embedding artifact fans out from it.
    key = f"{settings.archive_media_prefix}{safe_name}"
